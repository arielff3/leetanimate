            ...
            <TabsContent value="javascript" className="mt-4">
              <div className="relative">
                <Button
                  ...
                  onClick={() => handleCopy(CODE_EXAMPLES.twopointers.javascript)}
                >
                  <Copy className="h-4 w-4" />
                </Button>
                <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm">{CODE_EXAMPLES.twopointers.javascript}</code>
                </pre>
              </div>
            </TabsContent>
            ...
            <TabsContent value="python" className="mt-4">
              <div className="relative">
                <Button
                  ...
                  variant="ghost"
                  className="absolute right-2 top-2"
                  onClick={() => handleCopy(CODE_EXAMPLES.twopointers.python)}
                >
                  <Copy className="h-4 w-4" />
                </Button>
                <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm">{CODE_EXAMPLES.twopointers.python}</code>
                </pre>
              </div>
            </TabsContent>
          </Tabs>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground">
              {t('algorithmExplanation.description')}
            </p>
          </div>
...
export default ValidPalindromeCode;
